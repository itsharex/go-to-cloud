    ...
    "definitions": {
        ...
        "deploy.DeploymentCondition": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/deploy.ConditionStatus"
                },
                "type": {
                    "type": "string"
                }
        ...
        "kube.ContainerDescription": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/kube.ContainerStatus"
                }
            }
        },
        "kube.ContainerStatus": {
            "type": "integer",
            "enum": [
                1,
                2,
            ...
            "x-enum-varnames": [
                ...
                "ContainerStatus_Terminated",
                "ContainerStatus_Waiting",
                "ContainerStatus_Unknown"
            ]
        },
        ...
        "pipeline.PlanCardModel": {
            ...
            "properties": {
                ...
                "lastBuildResult": {
                    "$ref": "#/definitions/pipeline.BuildingResult"
                },
                "lint_check": {
                    "type": "string"
                },
